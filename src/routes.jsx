...
const AsyncFullHouseAction = MyLoadable({ loader: () => import('./components/pages/fullHouseAction/fullHouseAction') });
    ...
    return (
      <TransitionGroup>
        <Switch>
          ...
          <ProjectLayout exact path="/dom-v-podarok-ot-servus" inverse={false} component={AsyncFullHouseAction}/>
