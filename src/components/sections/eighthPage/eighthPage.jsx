...
class EighthPage extends React.Component {
  ...
  render() {
    ...
    const footer = <Button bsStyle="link" className="btn-yellow">
      Узнать стоимость строительства этого проекта
    </Button>;
    return (
        ...
        <Row className="steps">
          <Col md={5}>
            ...
            <p>
              ...
              в нашем каталоге. Там же можно оставить заявку на расчет стоимости строительства понравившегося дома (это бесплатно).
            </p>
            <p>
