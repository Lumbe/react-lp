...
class NinthPage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {animateIn: true, pageId: 9};
  }
                    ...
                    <div className="icon-wrapper">
                      ...
                      <div className="description-wrapper">
                        <div className="description-block">
                          Каркас дома с крышей строится 30 дней. Готовый к заселению "дом под ключ" строится за 3-4 месяца (от подписания договора до заселения в дом)
                        </div>
                      </div>
                    </div>
                  </Col>
