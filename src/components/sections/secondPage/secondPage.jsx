      ...
      <FadeTransition shouldShow={this.state.animateIn} timeout={650} classNames="fade">
        <Page>
          ...
          <Helmet>
            ...
            <meta
              name="description"
              content='Официальное представительство компании Сервус в Виннице и Винницкой области. Строим дома и коттеджи за 3 месяца'
            />
              ...
              <Row>
                ...
                <Col md={8}>
                  ...
                  <p className="p-highlight">Строим энергосберегающие дома и коттеджи из СИП-панелей в Виннице и Винницкой области.
                    ...
                    от разработки проекта дома до сдачи объекта. Проектируем, производим и строим в самые короткие сроки -
                    дом на 120кв.м. строится за 3-4 месяца </p></div>
                </Col>
              </Row>
