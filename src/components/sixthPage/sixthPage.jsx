      ...
      <div className="fourth-section">
        <Row>
          <Col md={12} className="text-center">
            ...
            <p className="description">От заключения договора до заселения в дом</p>
          </Col>
        </Row>
        <Row>
          <Col md={2} mdOffset={1}>
            <div className="icon-wrapper">
              ...
              <div className="description-wrapper">
                <div className="description-block">С момента основания компании Сервус в 2005 году мы постепенно расширяли производственно</div>
              </div>
            </div>
          </Col>
          <Col md={2}>
